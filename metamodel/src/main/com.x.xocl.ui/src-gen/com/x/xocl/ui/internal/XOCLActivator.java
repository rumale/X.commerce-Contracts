 ...
 * generated by Xtext
 */
package com.x.xocl.ui.internal;
 ...
 * introduced subclass. 
 */
public class XOCLActivator extends AbstractUIPlugin {
	
	private static final Logger logger = Logger.getLogger(XOCLActivator.class);
	...
	private static XOCLActivator INSTANCE;
	
	public static final String COM_X_XOCL_XOCL = "com.x.xocl.XOCL";
	...
	public static XOCLActivator getInstance() {
		return INSTANCE;
	}
	
	protected Module getRuntimeModule(String grammar) {
		if (COM_X_XOCL_XOCL.equals(grammar)) {
			return new com.x.xocl.XOCLRuntimeModule();
		}
	...
	protected Module getUiModule(String grammar) {
		if (COM_X_XOCL_XOCL.equals(grammar)) {
			return new com.x.xocl.ui.XOCLUiModule(this);
		}
